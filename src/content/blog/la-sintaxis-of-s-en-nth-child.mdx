---
title: "La desconocida sintaxis de `of S` en `:nth-child()`"
description: "Una función poderosa (y olvidada) de `:nth-child()` que te deja seleccionar con precisión quirúrgica en CSS moderno."
pubDate: "2025-05-02"
...
import Demo1 from "../../components/demos-blog/la-sintaxis-of-s-en-nth-child/1.astro";
import Demo2 from "../../components/demos-blog/la-sintaxis-of-s-en-nth-child/2.astro";
...
Hoy vas a diseccionar la famosa fórmula `An+B` de CSS. Hoy vas a aprender a usar el selector `:nth-child()` con su nueva y mejorada sintaxis `of S`.

## TL;DR

```css
/* Sintaxis: :nth-child(An+B [of S]?) */
```
...
- Esta sintaxis es compatible con `:nth-last-child()`.

![Meme de CSS](../../assets/blog/la-sintaxis-of-s-en-nth-child/image.png)
