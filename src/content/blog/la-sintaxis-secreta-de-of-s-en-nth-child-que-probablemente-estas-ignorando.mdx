...
published: true
tags: ["CSS", "TIL"]
ogImage: "https://baumannzone-dev-og.vercel.app/api/og?title=La%20sintaxis%20secreta%20de%20`of%20S`%20en%20`:nth-child()`%20que%20probablemente%20est%C3%A1s%20ignorando&tags=CSS,TIL"
twitterImage: "https://baumannzone-dev-og.vercel.app/api/og?title=La%20sintaxis%20secreta%20de%20`of%20S`%20en%20`:nth-child()`%20que%20probablemente%20est%C3%A1s%20ignorando&tags=CSS,TIL"
ogTitle: "La sintaxis secreta de `of S` en `:nth-child()` que probablemente estás ignorando"
ogDescription: "Descubre cómo usar `:nth-child(of S)` para seleccionar elementos con una precisión quirúrgica digna de CSS moderno y evita errores comunes que ni sabías que estabas cometiendo."
---
