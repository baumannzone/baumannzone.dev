...
tags:
  - JavaScript
relatedPosts:
  - "sabias-que-tu-navegador-puede-hablar"
  - "que-son-y-como-crear-identificadores-unicos-uuids-con-javascript-plano"
...
import Demo1 from "../../components/demos-blog/evita-que-la-pantalla-se-duerma-con-javascript-domina-la-screen-wake-lock-api/1.astro";
...
Aquí tienes una demo funcional para probar la API en tiempo real. Activa el _wake lock_, cambia de pestaña y vuelve para ver cómo se libera y se intenta recuperar cuando la página vuelve a estar visible.
